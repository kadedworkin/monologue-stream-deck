...
import type { DialDownEvent, DialRotateEvent, DialUpEvent, DidReceiveResourcesEvent, DidReceiveSettingsEvent, KeyDownEvent, KeyUpEvent, PropertyInspectorDidAppearEvent, PropertyInspectorDidDisappearEvent, SendToPluginEvent, TitleParametersDidChangeEvent, TouchTapEvent, WillAppearEvent, WillDisappearEvent } from "../events/index.js";
/**
 ...
 */
export declare class SingletonAction<T extends JsonObject = JsonObject> {
    /**
     ...
     */
    get actions(): Enumerable<DialAction<T> | KeyAction<T>>;
    /**
     ...
     */
    onDialDown?(ev: DialDownEvent<T>): Promise<void> | void;
    /**
     * Occurs when the user rotates a dial (Stream Deck +).
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onDialRotate?(ev: DialRotateEvent<T>): Promise<void> | void;
    /**
     ...
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onDialUp?(ev: DialUpEvent<T>): Promise<void> | void;
    /**
     * Occurs when the resources were updated within the property inspector.
     * @param listener Function to be invoked when the event occurs.
     */
    onDidReceiveResources?(ev: DidReceiveResourcesEvent<T>): Promise<void> | void;
    /**
     ...
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onDidReceiveSettings?(ev: DidReceiveSettingsEvent<T>): Promise<void> | void;
    /**
     ...
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onKeyDown?(ev: KeyDownEvent<T>): Promise<void> | void;
    /**
     ...
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onKeyUp?(ev: KeyUpEvent<T>): Promise<void> | void;
    /**
     ...
     */
    onPropertyInspectorDidAppear?(ev: PropertyInspectorDidAppearEvent<T>): Promise<void> | void;
    /**
     ...
     * @param ev Information about the event, including the source action.
     */
    onPropertyInspectorDidDisappear?(ev: PropertyInspectorDidDisappearEvent<T>): Promise<void> | void;
    /**
     ...
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onSendToPlugin?(ev: SendToPluginEvent<JsonValue, T>): Promise<void> | void;
    /**
     * Occurs when the user updates an action's title settings in the Stream Deck application. See also {@link Action.setTitle}.
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onTitleParametersDidChange?(ev: TitleParametersDidChangeEvent<T>): Promise<void> | void;
    /**
     * Occurs when the user taps the touchscreen (Stream Deck +).
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onTouchTap?(ev: TouchTapEvent<T>): Promise<void> | void;
    /**
     * Occurs when an action appears on the Stream Deck due to the user navigating to another page, profile, folder, etc. This also occurs during startup if the action is on the "front
     * page". An action refers to _all_ types of actions, e.g. keys, dials,
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onWillAppear?(ev: WillAppearEvent<T>): Promise<void> | void;
    /**
     * Occurs when an action disappears from the Stream Deck due to the user navigating to another page, profile, folder, etc. An action refers to _all_ types of actions, e.g. keys,
     * dials, touchscreens, pedals, etc.
     * @param ev Information about the event, including the source action and contextual payload information.
     */
    onWillDisappear?(ev: WillDisappearEvent<T>): Promise<void> | void;
}
