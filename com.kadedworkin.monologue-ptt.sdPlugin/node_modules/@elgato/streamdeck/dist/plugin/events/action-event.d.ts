 ...
 */
export declare class ActionWithoutPayloadEvent<TSource extends Extract<PluginEvent, ActionIdentifier & DeviceIdentifier>, TAction> extends Event<TSource> {
 ...
 * Provides information for an event relating to an action.
 */
export declare class ActionEvent<TSource extends Extract<PluginEvent, ActionIdentifier & DeviceIdentifier> & PayloadEvent<TSource>, TAction> extends ActionWithoutPayloadEvent<TSource, TAction> {
    /**
...
} ? TPayload extends object ? TPayload : never : never;
/**
