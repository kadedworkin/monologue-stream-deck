 ...
 */
type ExtractLanguage<T extends string> = T extends `_` | `-` | `` ? never : T extends Alphabetical<T> ? T : T extends `${infer L}${`_` | `-`}${infer R}` ? L extends Alphabetical<L> ? R extends Alphabetical<R> ? L | T : never : never : never;
export {};
