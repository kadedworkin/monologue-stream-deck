import { type IDisposable, type JsonObject } from "@elgato/utils";
import type { DialDownEvent, DialRotateEvent, DialUpEvent, DidReceiveResourcesEvent, KeyDownEvent, KeyUpEvent, TitleParametersDidChangeEvent, TouchTapEvent, WillAppearEvent, WillDisappearEvent } from "../events/index.js";
import type { SingletonAction } from "./singleton-action.js";
import { ReadOnlyActionStore } from "./store.js";
/**
...
declare class ActionService extends ReadOnlyActionStore {
     ...
     * @returns A disposable that, when disposed, removes the listener.
     */
    onDidReceiveResources<T extends JsonObject = JsonObject>(listener: (ev: DidReceiveResourcesEvent<T>) => void): IDisposable;
    /**
